...
namespace Mantis.Analyzer.Core.Common
{
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class RequireSequenceGroupAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "Mantis_RequireSequenceGroup";
...
#pragma warning restore RS1033 // Define diagnostic description correctly
        ...
        private const string _sequenceGroupAttribute = "Mantis.Core.Common.Attributes.SequenceGroupAttribute";
        private const string _requireSequenceGroupAttribute = "Mantis.Core.Common.Attributes.RequireSequenceGroupAttribute";
        private const string _requireGenericSequenceGroupAttribute = "Mantis.Core.Common.Attributes.RequireGenericSequenceGroupAttribute";
        ...
        private static void AnalyzeSymbol(SymbolAnalysisContext context)
        {
            ...
            {
                if (interfaceSymbol.Name == "IRuntimeSequenceGroup" && interfaceSymbol.ContainingNamespace.ToString() == "Mantis.Core.Common.Interfaces")
                {
