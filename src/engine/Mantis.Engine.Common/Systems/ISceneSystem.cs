namespace Mantis.Engine.Common.Systems
{
    ...
    /// Generally a scoped service registered via <see cref="Extensions.ContainerBuilderExtensions.RegisterSceneSystem{TSystem}(Autofac.ContainerBuilder){TSystem}(Autofac.ContainerBuilder)"/>
