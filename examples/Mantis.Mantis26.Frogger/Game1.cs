...
using Mantis.Mantis26.Frogger.Scenes;
using Mantis.Mantis26.Frogger.Systems;
    ...
    public sealed class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Game1()
        {
            ...
            this._mantis = new MantisEngine(builder =>
            {
                ...
                builder.RegisterType<Camera>().AsSelf().InstancePerLifetimeScope();
                builder.RegisterSceneSystem<EngineSystem>();
                builder.RegisterSceneSystem<TextureSystem>();
                builder.RegisterSceneSystem<ControllableSystem>();
                builder.RegisterSceneSystem<VelocitySystem>();
                builder.RegisterSceneSystem<SpawnerSystem>();
                builder.RegisterSceneSystem<CollisionSystem>();
            });
